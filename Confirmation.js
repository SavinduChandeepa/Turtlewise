document.addEventListener('DOMContentLoaded', function () {
    ...
    const confirmedName = localStorage.getItem("confirmedName");
    ...
    const confirmedNameElement = document.getElementById('confirmedName');
    const confirmedPhoneElement = document.getElementById('confirmedPhone');
    const confirmedEmailElement = document.getElementById('confirmedEmail');

    confirmedNameElement.textContent = confirmedName;
    confirmedPhoneElement.textContent = confirmedPhone;
    confirmedEmailElement.textContent = confirmedEmail;
